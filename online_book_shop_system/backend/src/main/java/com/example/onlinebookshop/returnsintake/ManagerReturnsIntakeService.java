...
@Service
public class ManagerReturnsIntakeService {
    private final ManagerReturnsIntakeRepository repo;

    public ManagerReturnsIntakeService(ManagerReturnsIntakeRepository repo) {
        this.repo = repo;
    }
