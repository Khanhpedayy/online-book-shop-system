...
public class ManagerLotController {

    private final ManagerLotService service;

    public ManagerLotController(ManagerLotService service) {
    ...
    public LotDetailDTO getById(@PathVariable Long id) {
    ...
    public ResponseEntity<Map<String, Object>> generateCopies(
            @PathVariable Long id, @RequestBody GenerateCopiesRequest req) {
