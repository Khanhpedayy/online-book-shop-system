...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    @Query("SELECT c FROM CartItem c JOIN FETCH c.variant v LEFT JOIN FETCH v.book WHERE c.user.id = :userId ORDER BY c.addedAt DESC")
    List<CartItem> findByUser_IdWithVariantAndBook(@Param("userId") Long userId);
