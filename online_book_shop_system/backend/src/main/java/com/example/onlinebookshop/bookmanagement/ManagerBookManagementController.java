...
@CrossOrigin(origins = "*")
@Tag(name = "2. ManagerBook Management")
public class ManagerBookManagementController {

    private final ManagerBookManagementService service;

    public ManagerBookManagementController(ManagerBookManagementService service) {
