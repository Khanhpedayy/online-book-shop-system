...
public class ManagerReturnsIntakeController {
    private final ManagerReturnsIntakeService service;

    public ManagerReturnsIntakeController(ManagerReturnsIntakeService service) {
