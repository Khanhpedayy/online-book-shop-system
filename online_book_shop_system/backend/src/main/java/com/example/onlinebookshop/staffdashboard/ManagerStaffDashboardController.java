...
public class ManagerStaffDashboardController {

    private final ManagerStaffDashboardService service;

    public ManagerStaffDashboardController(ManagerStaffDashboardService service) {
